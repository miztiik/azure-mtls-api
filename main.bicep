...
module r_dataCollectionRule 'modules/monitor/data_collection_rule.bicep' = {
  name: '${deploymentParams.enterprise_name_suffix}_${deploymentParams.loc_short_code}_${deploymentParams.global_uniqueness}dcr'
  params: {
    deploymentParams: deploymentParams
    osKind: 'Linux'
    tags: tags
...
module r_vm 'modules/vm/create_vm.bicep' = {
  ...
  params: {
    ...
    vm_params: vm_params
    vnet_name: r_vnet.outputs.vnet_name
    vm_subnet_name: r_vnet.outputs.web_subnet_01_name
    no_of_vms: 1
...
output apim_url string = r_apim_svc.outputs.svc_url
